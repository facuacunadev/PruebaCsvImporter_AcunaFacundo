...
namespace CsvImporter.Business.ImporterManager.Implementation
{
    public class CSVDataImporterManager : ICSVDataImporter
    {
        
        private ICSVDataReader _reader;
        private IAcmeDatabaseConnection _connection;
        protected readonly ILogger<CSVDataImporterManager> _logger;

        public CSVDataImporterManager(ICSVDataReader reader, IAcmeDatabaseConnection connection, ILoggerFactory loggerFactory)
        {
            _reader = reader;
